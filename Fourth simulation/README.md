...
The code is very similar to the third simulation. You can see the changes in the **commander.py** file. It has been changed to see in a better way the RFID antennas. 
