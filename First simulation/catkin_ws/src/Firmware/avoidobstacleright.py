...
class ObstacleRightAvoider:
    ...
    def block_right_movement(self, message): # Function called to move the drone X distance to avoid the obstacle

        self.blockmovementright.publish(message) # It publishes the float distance to move
