...
class ObstacleUpAvoider:
    ...
    def avoid_up_obstacle(self, distance_obst_avoid): # Function called to move the drone X distance to avoid the obstacle
    ...
    def avoid_up_obstacle_return(self, distance_obst_avoid): # Function called to move the drone X distance to avoid the obstacle
    ...
    def block_up_movement(self, message): # Function called to move the drone X distance to avoid the obstacle

        self.blockmovementup.publish(message) # It publishes the float distance to move
